...
export const sectionItems: SectionItem[] = [
  ...
  { id: 'c', label: 'C: Ideation', icon: FlaskConical },
  { id: 'c1', label: 'C1: Ideation-Dokumentation', icon: Circle, isSubItem: true },
  { id: 'c2', label: 'C2: Teamwork-Reflexion', icon: Circle, isSubItem: true },
  { id: 'c3', label: 'C3: Priorisierung & Entscheid', icon: Circle, isSubItem: true },
